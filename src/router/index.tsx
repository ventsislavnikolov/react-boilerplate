    ...
    <div className='flex min-h-screen flex-col'>
      <header className='py-4'>
        <button
          ...
          onClick={() => handleButtonClick(i18n.language === 'en' ? 'en' : 'en')}
        >
          {i18n.language === 'en' ? t('home.english') : t('home.english')}
        </button>
      </header>
      <main className='flex flex-1 flex-col items-center justify-between p-24'>
        <p className='pb-3 text-2xl underline'>{t('home.hello-boilerplate')}</p>
      </main>
